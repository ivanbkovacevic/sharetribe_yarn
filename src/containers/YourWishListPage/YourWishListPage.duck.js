...
export const FETCH_LISTINGS_REQUEST = 'app/YourWishListPage/FETCH_LISTINGS_REQUEST';
export const FETCH_LISTINGS_SUCCESS = 'app/YourWishListPage/FETCH_LISTINGS_SUCCESS';
export const FETCH_LISTINGS_ERROR = 'app/YourWishListPage/FETCH_LISTINGS_ERROR';

export const OPEN_LISTING_REQUEST = 'app/YourWishListPage/OPEN_LISTING_REQUEST';
export const OPEN_LISTING_SUCCESS = 'app/YourWishListPage/OPEN_LISTING_SUCCESS';
export const OPEN_LISTING_ERROR = 'app/YourWishListPage/OPEN_LISTING_ERROR';

export const CLOSE_LISTING_REQUEST = 'app/YourWishListPage/CLOSE_LISTING_REQUEST';
export const CLOSE_LISTING_SUCCESS = 'app/YourWishListPage/CLOSE_LISTING_SUCCESS';
export const CLOSE_LISTING_ERROR = 'app/YourWishListPage/CLOSE_LISTING_ERROR';

export const ADD_OWN_ENTITIES = 'app/YourWishListPage/ADD_OWN_ENTITIES';
...
const YourWishListPageReducer = (state = initialState, action = {}) => {
...
export default YourWishListPageReducer;
...
export const getOwnListingsById = (state, listingIds) => {
  const { ownEntities } = state.YourWishListPage;
